...
public class Matchmaker : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    {
        Debug.Log("Matchmaker TryHostSession");
    ...
    */
    ...
    public void TryJoinRandomSession(System.Action successCallback = null)
    {
        StartCoroutine(JoinRandomSessionRoutine(successCallback));
    }

    IEnumerator JoinRandomSessionRoutine(System.Action successCallback)
    {
        if (Runner) Runner.Shutdown();
        Runner = Instantiate(runnerPrefab);
