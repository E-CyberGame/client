...
public class PlayerSpawner2 : SimulationBehaviour, IPlayerJoined
{
    ...
    public GameObject Player1Matching;
    public GameObject Player2Matching;

    public GameObject PlayerUI;

    public TextMeshProUGUI ReadyText1;
    public TextMeshProUGUI ReadyText2;
    ...
    [Networked] public bool isPlaying { get; set; } = false;
